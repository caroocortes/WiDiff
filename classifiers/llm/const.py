...
CLASS_DESCRIPTION = {
    ...
    'text': {
        ...
        "For standard abbreviations (e.g., 'Saint' -> 'St.') we consider them as a textual_change, but for name abbreviations (e.g., 'J.' -> 'John') we consider them a refinement because from there are multiple names that can start with a specific letter.",
